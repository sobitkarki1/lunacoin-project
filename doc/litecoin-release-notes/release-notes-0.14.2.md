...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/lunacoin-project/litecoin/blob/master/src/chainparams.cpp#L220).
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/lunacoin-project/litecoin/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/lunacoin-project/litecoin/blob/master/doc/zmq.md) for
now ZMQ can be used on Windows. Please see [this document](https://github.com/lunacoin-project/litecoin/blob/master/doc/zmq.md) for
