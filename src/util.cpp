...
const char * const BITCOIN_CONF_FILENAME = "lunacoin.conf";
const char * const BITCOIN_PID_FILENAME = "lunacoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lunacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lunacoin";
#else
    // Unix
    return pathRet / ".lunacoin";
#endif
#endif
}
