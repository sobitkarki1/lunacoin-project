...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lunacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lunacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lunacoin transaction") + "\n" +
              "  lunacoin-tx [options] -create [commands]   " + _("Create hex-encoded lunacoin transaction") + "\n" +
              "\n";
