...
"""Verify that starting lunacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lunacoin with -h for help text")
        ...
        self.log.info("Start lunacoin with -version for version information")
